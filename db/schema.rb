...
ActiveRecord::Schema.define(version: 20161208064917) do
  ...
  create_table "intervenants", force: :cascade do |t|
    ...
    t.index ["email"], name: "index_intervenants_on_email", unique: true
    t.index ["reset_password_token"], name: "index_intervenants_on_reset_password_token", unique: true
  end
